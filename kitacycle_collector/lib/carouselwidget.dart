...
import 'package:kitacycle_collector/price_list.dart';
...
class _CarouselState extends State<Carousel> {
  ...
  void initState() {
    super.initState();
    _pageController = PageController(initialPage: 1, viewportFraction: .23);
  }
