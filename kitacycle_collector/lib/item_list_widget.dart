      ...
      child: ListView(
        ...
        children: [
          CategoryCardMallika1(
            title: "Plastics",
            image: "assets/img_plasticremovebgpreview.png",
            onTap: () {
              setState(() {
          ...
          CategoryCardMallika1(
            title: "Paper",
            image: "assets/img_paperremovebgpreview.png",
            onTap: () {
              setState(() {
          ...
          CategoryCardMallika1(
            title: "Can",
            image: "assets/img_canremovebgpreview.png",
            onTap: () {
              setState(() {
          ...
          CategoryCardMallika1(
            title: "Cooking Oil",
            image: "assets/img_icons8cookingoil96.png",
            onTap: () {
              setState(() {
          ...
          CategoryCardMallika1(
            title: "Box",
            image: "assets/img_icons8openbox16.png",
            onTap: () {
              setState(() {
